...
class Vehicle : public FactGroup
{
    ...
    Q_PROPERTY(float pitchinsM1 READ pitchinsM1 NOTIFY dataChanged) //RYY
    Q_PROPERTY(float rollinsM1 READ rollinsM1 NOTIFY dataChanged) //RYY
    Q_PROPERTY(float yawinsM1 READ yawinsM1 NOTIFY dataChanged) //RYY
    Q_PROPERTY(float depthinsM1 READ depthinsM1 NOTIFY dataChanged) //RYY
    Q_PROPERTY(float latinsM1 READ latinsM1 NOTIFY dataChanged) //RYY
    Q_PROPERTY(float longinsM1 READ longinsM1 NOTIFY dataChanged) //RYY
    Q_PROPERTY(float topprofM1 READ topprofM1 NOTIFY dataChanged) //RYY
    Q_PROPERTY(float rightprofM1 READ rightprofM1 NOTIFY dataChanged) //RYY
    Q_PROPERTY(float downprofM1 READ downprofM1 NOTIFY dataChanged) //RYY
    Q_PROPERTY(float leftprofM1 READ leftprofM1 NOTIFY dataChanged) //RYY

    Q_PROPERTY(float topAltM1 READ topAltM1 NOTIFY dataChanged) //RYY
    Q_PROPERTY(float rightAltM1 READ rightAltM1 NOTIFY dataChanged) //RYY
    Q_PROPERTY(float downAltM1 READ downAltM1 NOTIFY dataChanged) //RYY
    Q_PROPERTY(float leftAltM1 READ leftAltM1 NOTIFY dataChanged) //RYY

    Q_PROPERTY(float topConfiM1 READ topConfiM1 NOTIFY dataChanged) //RYY
    Q_PROPERTY(float rightConfiM1 READ rightConfiM1 NOTIFY dataChanged) //RYY
    Q_PROPERTY(float downConfiM1 READ downConfiM1 NOTIFY dataChanged) //RYY
    Q_PROPERTY(float leftConfiM1 READ leftConfiM1 NOTIFY dataChanged) //RYY

    Q_PROPERTY(float speedM1 READ speedM1 NOTIFY dataChanged) //RYY Speed
...
public:
    ...
    // set kalman parameter RYY------------

    Q_INVOKABLE void setKalmangval(float value); // Declare Q_INVOKABLE method to set kalmangval

    float kalmangval() const; // Getter method for kalmangval

    Q_INVOKABLE void setnoiseval(float value); // Declare Q_INVOKABLE method to set setnoiseval

    float noiseval() const; // Getter method for setnoiseval

    Q_INVOKABLE void setsafetyval(float value); // Declare Q_INVOKABLE method to set setsafety

    float safetyval() const; // Getter method for setsafetyval

    Q_INVOKABLE void setactivecenter(float value); // Declare Q_INVOKABLE method to set active centering

    float activecenterval() const; // Getter method for activeval centering

    Q_INVOKABLE void setactiveyaw(float value); // Declare Q_INVOKABLE method to set active yaw

    float activeyawval() const; // Getter method for yaw


    Q_INVOKABLE void setaltimeter(float value); // Declare Q_INVOKABLE method to set active altimeter

    float altimeterval() const; // Getter method for altimeterval

    Q_INVOKABLE void setprofiling(float value); // Declare Q_INVOKABLE method to set active profiling

    float profilingval() const; // Getter method for profilingval

    Q_INVOKABLE void setINS(float value); // Declare Q_INVOKABLE method to set active INS

    float INSval() const; // Getter method for INSval

    Q_INVOKABLE void sethorizontal(float value); // Declare Q_INVOKABLE method to set active horizontal only

    float horizontalval() const; // Getter method for horizontal only

    Q_INVOKABLE void setvertical(float value); // Declare Q_INVOKABLE method to set active vertical only

    float verticalval() const; // Getter method for vertical only

    Q_INVOKABLE void setthresholdval(float value); // Declare Q_INVOKABLE method to set threshold

    float thresholdval() const; // Getter method for thresholdval


    Q_INVOKABLE void setcalibval(float value); // Declare Q_INVOKABLE method to set altitudeval

    float calibval() const; // Getter method for altitudeval


    // set offset parameter RYY------------

    Q_INVOKABLE void topoffset(float value); // Declare Q_INVOKABLE method to set topoffset

    float topoffsetval() const; // Getter method for topoffset

    Q_INVOKABLE void activetopoffset(float value); // Declare Q_INVOKABLE method to set activetopoffset

    float activetopoffsetval() const; // Getter method for active topoffset

    Q_INVOKABLE void downoffset(float value); // Declare Q_INVOKABLE method to set downoffset

    float downoffsetval() const; // Getter method for downoffset

    Q_INVOKABLE void activedownoffset(float value); // Declare Q_INVOKABLE method to set downoffset

    float activedownoffsetval() const; // Getter method for downoffset


    Q_INVOKABLE void leftoffset(float value); // Declare Q_INVOKABLE method to set leftoffset

    float leftoffsetval() const; // Getter method for leftoffset

    Q_INVOKABLE void activeleftoffset(float value); // Declare Q_INVOKABLE method to set leftoffset

    float activeleftoffsetval() const; // Getter method for leftoffset


    Q_INVOKABLE void rightoffset(float value); // Declare Q_INVOKABLE method to set rightoffset

    float rightoffsetval() const; // Getter method for rightoffset

    Q_INVOKABLE void activerightoffset(float value); // Declare Q_INVOKABLE method to set rightoffset

    float activerightoffsetval() const; // Getter method for rightoffset


    Q_INVOKABLE void activecruise(float value); // Declare Q_INVOKABLE method to set cruise

    float activecruiseval() const; // Getter method for cruise

    Q_INVOKABLE void activebackward(float value); // Declare Q_INVOKABLE method to set cruise

    float activebackwardval() const; // Getter method for cruise

    Q_INVOKABLE void activecalib(float value); // Declare Q_INVOKABLE method to set calib

    float activecalibval() const; // Getter method for calib

    //set vertical movement
    void _HandleAttitudeCustom(double pitchDeg);

    //set kalman filter RYY----------

    void centeringkalman(float roll, float pitch, float yaw, float thrust, quint16 buttons);


    Q_INVOKABLE void connectionudp(int value); // Declare Q_INVOKABLE method to set udp
    QMap<QString, QString> splitString(const QStringList& fieldNames, const QString& input);
    void processData(const QString& type, const QString& joinedValues, const QStringList& fieldNames);
    void updateQMLText(const QString& fieldName, const QString& type, const QMap<QString, QString>& splitedData);
    void storeData(const QString& type, const QMap<QString, QString>& splitedData);

    // set offset kalman filter RYY ---
    void offsetkalman(int pilih, float roll, float pitch, float yaw, float thrust, quint16 buttons);




    float pitchinsM = 0.0f;
    float rollinsM = 0.0f;
    float yawinsM = 0.0f;
    float latitudeinsM = 0.0f;
    float longitudeinsM = 0.0f;
    float depthinsM = 0.0f;
    float topprofM = 0.0f;
    float rightprofM = 0.0f;
    float downprofM = 0.0f;
    float leftprofM = 0.0f;
    float topAltM = 0.0f;
    float topConfiM = 0.0f;
    float rightAltM = 0.0f;
    float rightConfiM = 0.0f;
    float downAltM = 0.0f;
    float downConfiM = 0.0f;
    float leftAltM = 0.0f;
    float leftConfiM = 0.0f;
    float speedM = 0.0f;

    float pitchinsM1() const;
    float rollinsM1() const;
    float yawinsM1() const;
    float depthinsM1() const;
    float latinsM1() const;
    float longinsM1() const;
    float topprofM1() const;
    float rightprofM1() const;
    float downprofM1() const;
    float leftprofM1() const;

    float topAltM1() const;
    float rightAltM1() const;
    float downAltM1() const;
    float leftAltM1() const;

    float topConfiM1() const;
    float rightConfiM1() const;
    float downConfiM1() const;
    float leftConfiM1() const;
...
signals:
    ...
    void kalmangvalChanged(float value); // Signal emitted when kalmangval changes RYY
    void noisevalChanged(float value); // Signal emitted when noise changes RYY
    void safetyvalChanged(float value); // Signal emitted when safety changes RYY
    void activevalChanged(int value); // Signal emitted when active changes RYY
    void altimetervalChanged(int value); // Signal emitted when altimeter changes RYY
    void profilingvalChanged(int value); // Signal emitted when profiling changes RYY
    void insvalChanged(int value); // Signal emitted when INS changes RYY
    void horvalChanged(int value); // Signal emitted when horizontal changes RYY
    void vervalChanged(int value); // Signal emitted when Vertical changes RYY
    void thresholdvalChanged(int value); // Signal emitted when threshold changes RYY

    void topoffsetvalChanged(float value); // Signal emitted when topoffset changes RYY
    void activetopoffsetvalChanged(float value); // Signal emitted when topoffset changes RYY
    void downoffsetvalChanged(float value); // Signal emitted when downoffset changes RYY
    void activedownoffsetvalChanged(float value); // Signal emitted when activedownoffset changes RYY
    void leftoffsetvalChanged(float value); // Signal emitted when leftoffset changes RYY
    void activeleftoffsetvalChanged(float value); // Signal emitted when activeleftoffset changes RYY
    void rightoffsetvalChanged(float value); // Signal emitted when rightoffset changes RYY
    void activerightoffsetvalChanged(float value); // Signal emitted when activerightoffset changes RYY
    void activeyawvalChanged(float value); // Signal emitted when activerightoffset changes RYY
    void activecruisevalChanged(float value); // Signal emitted when activecruise changes RYY
    void activebackwardvalChanged(float value); // Signal emitted when activecruise changes RYY
    void activecalibvalChanged(float value); // Signal emitted when activecalib changes RYY
    void altitudevalChanged(float value); // Signal emitted when altitude changes RYY
    void dataChanged();
...
private:
    ...
    float _kalmangval; //RYY
    float _centerthreshold; //RYY
    float _noiseval; //RYY
    float _safetyval; //RYY
    int _activeval; //RYY
    int _altimeterval; //RYY
    int _profilingval; //RYY
    int _insval; //RYY
    int _horval; //RYY
    int _verval; //RYY
    float _topoffsetval; //RYY
    int _activetopoffsetval; //RYY
    float _downoffsetval; //RYY
    int _activedownoffsetval; //RYY
    float _leftoffsetval; //RYY
    int _activeleftoffsetval; //RYY
    float _rightoffsetval; //RYY
    int _activerightoffsetval; //RYY
    int _activeyawval; //RYY
    int _activecruiseval; //RYY
    int _activebackwardval; //RYY
    float _calibsetval; //RYY
    int _activecalibval; //RYY
