...
exists ($$PWD/.git) {
    ...
    message(JDW - GIT_BRANCH $${GIT_BRANCH})
    message(JDW - GIT_HASH $${GIT_HASH})
    message(JDW - GIT_TIME $${GIT_TIME})
    message(JDW - GIT PWD git --git-dir $$PWD/.git --work-tree $$PWD describe --always --tags)
